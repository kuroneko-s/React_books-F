...
var btnDecrease = document.querySelector("#decrease"); // action type

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE";

var createToggleSwitch = function createToggleSwitch() {
  return {
    type: TOGGLE_SWITCH
  };
};

var createIncrease = function createIncrease(difference) {
  return {
    type: INCREASE,
...
var createDecrease = function createDecrease() {
  return {
    type: DECREASE
  };
...
var render = function render() {
  var state = store.getState(); // 현재 상태 가져옴
...
render(); // store의 상태 값이 바뀔때마다 render 함수가 동작한다.
...
//# sourceMappingURL=/React-books_16-F.e31bb0bc.js.map